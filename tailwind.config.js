    ...
    extend: {
      ...
      keyframes: {
        ...
        'alert-slide': {
          '0%': {
            opacity: '0',
            transform: 'translateX(80px) scale(0.98) skewX(-8deg)',
            filter: 'blur(2px)',
          },
          '60%': {
            opacity: '1',
            transform: 'translateX(-6px) scale(1.01) skewX(2deg)',
            filter: 'blur(0px)',
          },
          '100%': {
            opacity: '1',
      ...
      animation: {
        ...
        'alert-slide': 'alert-slide 0.65s cubic-bezier(0.22, 0.61, 0.36, 1) both',
        'alert-shimmer': 'alert-shimmer 0.9s ease-out 0.1s both',
      },
    },
  },
  plugins: [
